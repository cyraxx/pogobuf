...
module.exports.register = function(client, deviceId) {
    ...
    let updateLocFixes = function() {
        let moving = (client.playerLatitude !== lastPos.latitude) || (client.playerLongitude !== lastPos.longitude);
        lastPos = {latitude: client.playerLatitude, longitude: client.playerLongitude};
    ...
    client.setOption('signatureInfo', function(envelope) {
        ...
        infos.sensor_info = [{
            timestamp_snapshot: (lastLocationFixTimeStamp - start) + randomInt(-800, 800), // close to last location update
