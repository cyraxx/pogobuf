...
* Uses [starkevin's enhanced fork](https://github.com/starkevin/node-pogo-signature) of [SpencerSharkey's node-pogo-signature](https://github.com/SpencerSharkey/node-pogo-signature) for request signing
